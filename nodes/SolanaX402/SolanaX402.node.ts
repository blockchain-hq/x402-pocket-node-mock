// x402-n8n-server/nodes/SolanaX402/SolanaX402.node.ts - Updated for SOL
  ...
  description: INodeTypeDescription = {
    ...
    properties: [
      // Operation
      {
        ...
        options: [
          ...
          },
          {
            name: 'Verify Payment',
            value: 'verifyPayment',
            description: 'Verify a Solana SOL payment transaction',
      ...
      // Fields for Return 402
      {
        ...
        default: 0.01,
        description: 'Amount in SOL required to access the resource',
        typeOptions: {
          minValue: 0.000001,
          numberPrecision: 9,
        },
      ...
      {
        displayName: 'Expected Amount (SOL)',
        name: 'expectedAmount',
        type: 'number',
        required: true,
        displayOptions: {
        ...
        default: 0.01,
        description: 'Expected payment amount in SOL',
        typeOptions: {
          minValue: 0.000001,
          numberPrecision: 9,
        },
